...
public final class CrateLootConfig {
    ...
    private static final class ConfigRoot {
        @SerializedName("crates") Map<String, CrateLootEntry> crates;
    }

    public static final class CrateLootEntry {
        @SerializedName("minRarity") private String minRarity;
        @SerializedName("maxRarity") private String maxRarity;
        ...
        @Nonnull public WeaponRarity getMaxRarity() {
