...
public final class ArmorRegistry {
    ...
    public static final String ABILITY_ROOT_ID = "Root_Shotcave_Armor_Ability";
    public static final String ABILITY_INTERACTION_ID = "Shotcave_Armor_Ability";
    ...
    private static final class Manifest {
        @SerializedName("armors") List<String> armors;
    }

    private static final class ArmorConfig {
        @SerializedName("itemId") String itemId;
        @SerializedName("displayName") String displayName;
        @SerializedName("setId") String setId;
        @SerializedName("slotType") String slotType;
        @SerializedName("setAbility") String setAbility;
    ...
    private static final class BaseStatsDef {
        @SerializedName("protection") float protection;
        @SerializedName("knockback") float knockback;
        @SerializedName("closeDmgReduce") float closeDmgReduce;
        @SerializedName("farDmgReduce") float farDmgReduce;
        @SerializedName("spikeDamage") float spikeDamage;
        @SerializedName("lifeBoost") float lifeBoost;
        @SerializedName("speedBoost") float speedBoost;
    }
