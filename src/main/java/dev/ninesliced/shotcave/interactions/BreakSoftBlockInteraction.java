...
public final class BreakSoftBlockInteraction extends SimpleInstantInteraction {
    ...
    protected void firstRun(@Nonnull InteractionType type,
        ...
        // Only destroy blocks registered in the destructible blocks config
        ...
        // Break the block. CrateBreakDropSystem handles drops and barrel gas
        // effects via the resulting BreakBlockEvent.
